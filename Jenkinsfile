...
pipeline {
    ...
    environment {
        ...
        GITHUB_REPONAME = 'ion-query-api'
        GITHUB_KEY = 'ion-query-api-github-key'
    }
    parameters {
            ...
            parallel {
                ...
                stage ('SonarCloud') {
                    ...
                    steps {
                        ...
                        withMaven(maven: 'M35', jdk: 'jdk11', globalMavenSettingsConfig: 'default-global-settings', mavenSettingsConfig: 'ion-maven-settings', mavenOpts: '${LINUX_MVN_RANDOM}') {
